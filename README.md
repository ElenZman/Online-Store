Данный проект создавался в рамках обучающего курса по ASP.Net. На данный момент проект находится в стадии завершения, тк как имеются нерешенные проблемы.
